...
<tr class="item <?php if ( ! empty( $class ) ) echo $class; ?>" data-order_item_id="<?php echo $item_id; ?>">
	...
	<td class="name">
		...
		<div class="view">
			<?php do_action('woocommerce_before_view_order_itemmeta', $item_id, $item, $_product) ?>
			<?php
			...
			?>
			<?php do_action('woocommerce_after_view_order_itemmeta', $item_id, $item, $_product) ?>
		</div>
		<div class="edit" style="display:none">
			<?php do_action('woocommerce_before_edit_order_itemmeta', $item_id, $item, $_product, $order) ?>
			...
			<?php do_action('woocommerce_after_edit_order_itemmeta', $item_id, $item, $_product, $order) ?>
		</div>
