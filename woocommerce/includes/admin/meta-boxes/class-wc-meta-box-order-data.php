...
} else if (QSOT::is_wc_back_one()) {
	qsot_underload_core_class('/includes/admin/post-types/meta-boxes/class-wc-meta-box-order-data.php');
} else {
	_deprecated_file(__FILE__, 'OTv1.5', '', 'Could not determine which underlying class to load for WC_Meta_Box_Order_Data().');
	die();
}
